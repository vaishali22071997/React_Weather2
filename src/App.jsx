...
function App() {
  ...
  return (
    ...
    <div className='w-full h-screen text-black px-8'>
      <h1 className='font-bold tracking-wide text-4xl'>Weather App</h1>
      <nav className='w-full p-3 flex justify-between items-center'>
       
        <div className='bg-white -mx-5 w-[15rem] overflow-hidden shadow-2xl rounded flex items-center p-2 gap-2'>
